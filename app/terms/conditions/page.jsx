...
const page = () => {
  return (
    <div className="terms-of-service bg-dark-100 p-4 text-white md:px-8">
      <h1 className="text-2xl font-bold">Terms of Service</h1>{" "}
      <p className="mt-6">
        This website is operated by Snacker. Throughout the site, the terms
        “we”, “us” and “our” refer to Snacker. Snacker offers this website,
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 1 - ONLINE STORE TERMS</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 2 - GENERAL CONDITIONS</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 5 - PRODUCTS OR SERVICES</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 7 - OPTIONAL TOOLS</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 8 - THIRD-PARTY LINKS</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 10 - PERSONAL INFORMATION</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 12 - PROHIBITED USES</h2>{" "}
      <p>
      ...
      <p>
        In no case shall Snacker, our directors, officers, employees,
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 14 - INDEMNIFICATION</h2>{" "}
      <p>
        You agree to indemnify, defend and hold harmless Snacker and our parent,
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 15 - SEVERABILITY</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 16 - TERMINATION</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 17 - ENTIRE AGREEMENT</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 18 - GOVERNING LAW</h2>{" "}
      <p>
      ...
      <h2 className="text-xl font-bold mt-6">SECTION 20 - CONTACT INFORMATION</h2>{" "}
      <p>
