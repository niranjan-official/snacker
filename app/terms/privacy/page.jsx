...
const page = () => {
  return (
    <div className="privacy-policy bg-dark-100 text-white p-4 md:p-8">
      <h1 className="text-2xl font-bold">PRIVACY STATEMENT</h1>

      <h2 className="mt-5 text-xl font-bold">SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</h2>
      <p>
      ...
      <h2 className="mt-5 text-xl font-bold">SECTION 2 - CONSENT</h2>
      ...
      <p>
        ...
        support@snacker.com or mailing us at: [Company Office Address]
      </p>

      <h2 className="mt-5 text-xl font-bold">SECTION 3 - DISCLOSURE</h2>
      <p>
        We may disclose your personal information if we are required by law to
        do so or if you violate our Terms of Service.
      </p>

      <h2 className="mt-5 text-xl font-bold">SECTION 4 - PAYMENT</h2>
      <p>
      ...
      <h2 className="mt-5 text-xl font-bold">SECTION 5 - THIRD-PARTY SERVICES</h2>
      <p>
      ...
      <h2 className="mt-5 text-xl font-bold">SECTION 6 - SECURITY</h2>
      <p>
      ...
      <h2 className="mt-5 text-xl font-bold">SECTION 7 - COOKIES</h2>
      <p>
        We use cookies to maintain the session of your user. It is not used to
        personally identify you on other websites.
      </p>

      <h2 className="mt-5 text-xl font-bold">SECTION 8 - AGE OF CONSENT</h2>
      <p>
      ...
      <h2 className="mt-5 text-xl font-bold">SECTION 9 - CHANGES TO THIS PRIVACY POLICY</h2>
      <p>
      ...
      <h2 className="mt-5 text-xl font-bold">QUESTIONS AND CONTACT INFORMATION</h2>
      <p>
        ...
        niranjansabarinath1521@gmail.com
      </p>
      <p className="mt-2">Development Team,</p>
      <p>Providence college of Engineering, Ala, Chengannur, Alapuzha District, Kerala</p>
    </div>
  );
};
